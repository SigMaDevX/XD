...
// For UUID v4 - using CommonJS compatible approach
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://poorcatcartoon_db_user:YvFeC8zrqBuHYyw0@cluster0.kluwgbg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
MongoClient.connect(MONGODB_URI, { useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    db.collection('deployments').createIndex({ username: 1 });
    db.collection('deployments').createIndex({ token: 1 });
  })
